# -*- coding: utf-8 -*-
"""
Created on Thu May 21 14:30:28 2020
...
# -*- coding: utf-8 -*-
"""
Created on Thu May 21 02:08:11 2020
...
student_model_filename = './hw7_kaggle_predict_model_git.bin'
...
print("SGD optimizer")
optimizer = optim.SGD(student_net.parameters(), lr=1e-2, momentum=0.901)
...
model_8b_filename  = './hw7_kaggle_predict_model_git_8_bit.bin'
...
student_net.eval()
prediction = []
predict_filename = 'hw7_kaggle_predict_SGD__git_liu.csv'
with torch.no_grad():
