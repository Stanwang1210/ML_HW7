...
from HW7_Q4_grouping_architecture import *
...
for epoch in range(300):
    ...
    if valid_acc > now_best_acc:
        ...
        torch.save(student_net.state_dict(), 'student_model_kaggle_SGD_grouping.bin')
...
print(f"\noriginal cost: {os.stat('student_model_kaggle_SGD_grouping.bin').st_size} bytes.")
params = torch.load('student_model_kaggle_SGD_grouping.bin')
...
encode16(params, '16_bit_model_SGD_grouping.pkl')
print(f"16-bit cost: {os.stat('16_bit_model_SGD_grouping.pkl').st_size} bytes.")
...
encode8(params, '8_bit_model_SGD_grouping.pkl')
print(f"8-bit cost: {os.stat('8_bit_model_SGD_grouping.pkl').st_size} bytes.")
...
MODLE_PATH = '8_bit_model_SGD_grouping.pkl'
...
with torch.no_grad():
    for i, data in enumerate(testing_dataloader):
        ...
        for y in test_label:
            prediction.append(y)
name = 'Hw7_output_SGD_grouping.csv' 
#將結果寫入 csv 檔
